...
const ROUTES: RouteDefinition[] = [
  {
    ...
    patterns: [
      /法律|律师|律所|案件|案号|案由|类案|法条|法院|裁判文书|人民法院案例库|法信|法蝉|企查查|国家企业信用|委托书|代理词|证据目录|起诉状|要素式诉状|答辩状|质证|文书包|立案|外部检索|法律意见书|合同审查|合同模板|标书|投标书|财产线索|被执行人|股权穿透|诉讼|仲裁|争议焦点|庭审笔录|庭审提纲|法律分析|应对策略|焦点提炼|材料入库|导入知识库|知识库导入|外部数据源|数据源接入/u,
